...
function Section3() {
    return (
        ...
        <div id="projects"className="part3">
            ...
            <a href="https://github.com/imanchamileva/jdld-project" target="_blank"><div className="projet4"><img data-aos="zoom-in-down" data-aos-duration="1000" data-aos-offset="500" src={image2} className="projet44" /></div></a>
                ...
                <a href="https://github.com/CaroCap/CoffeeWars" target="_blank"><div className="projet4"><img data-aos="zoom-in-down" data-aos-duration="1000" data-aos-offset="500" src={image3} className="projet44" /></div></a>
